import { InjectionToken, EventEmitter, ɵɵdirectiveInject, PLATFORM_ID, NgZone, ElementRef, KeyValueDiffers, ɵɵdefineDirective, ɵɵNgOnChangesFeature, ɵsetClassMetadata, Directive, Inject, Optional, Input, Output, ChangeDetectorRef, ɵɵdefineComponent, ɵɵviewQuery, ɵɵqueryRefresh, ɵɵloadQuery, ɵɵprojectionDef, ɵɵelementStart, ɵɵprojection, ɵɵelementEnd, ɵɵelement, ɵɵlistener, ɵɵclassProp, ɵɵproperty, ɵɵadvance, ɵɵattribute, Component, ViewEncapsulation, ViewChild, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
SwiperComponent.ɵcmp = ɵɵdefineComponent({ type: SwiperComponent, selectors: [["swiper"]], viewQuery: function SwiperComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵɵviewQuery(SwiperDirective, true);
    } if (rf & 2) {
        var _t;
...
SwiperModule.ɵmod = ɵɵdefineNgModule({ type: SwiperModule });
SwiperModule.ɵinj = ɵɵdefineInjector({ factory: function SwiperModule_Factory(t) { return new (t || SwiperModule)(); }, imports: [[CommonModule], CommonModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SwiperModule, { declarations: [SwiperComponent, SwiperDirective], imports: [CommonModule], exports: [CommonModule, SwiperComponent, SwiperDirective] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(SwiperModule, [{
        type: NgModule,
        args: [{
